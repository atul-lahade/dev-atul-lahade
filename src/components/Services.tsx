          ...
          <div className="bg-cream-light-color dark:bg-black-color py-60px md:py-20 lg:py-30 overflow-x-hidden">
            <div className="container">
              ...
              <div className="services-widget relative">
                <div
                  className="service-item current px-15px lg:px-30px border dark:border-0 dark:border-b border-body-color dark:border-seondary-color relative z-10 group wow fadeInUp"
                  data-wow-delay=".5s">
                  <a href="service-details.html"
                    ...
                    <i
                      className="flaticon-up-right-arrow text-size-15 md:text-xl text-primary-color group-hover:text-white-color absolute top-[20%] md:top-1/2 right-5 lg:right-[55px] transition-all duration-300"></i>
                  </a>
                </div>
                <div
                  className="service-item px-15px lg:px-30px border dark:border-0 dark:border-b border-body-color dark:border-seondary-color relative z-10 group wow fadeInUp"
                  data-wow-delay=".6s">
                  <a href="service-details.html"
                    className="text-primary-color dark:text-white-color flex items-center gap-15px md:gap-5 flex-wrap md:flex-nowrap py-5 lg:py-30px group-hover:text-white">
                    <span
                      ...
                      <b className="text-xl md:text-size-25 lg:text-3xl">CMS Development</b>
                    </span>
                    ...
                    <i
                      className="flaticon-up-right-arrow text-size-15 md:text-xl text-primary-color group-hover:text-white-color absolute top-[20%] lg:top-1/2 right-5 lg:right-[55px] transition-all duration-300"></i>
                  </a>
                </div>
                <div
                  className="service-item px-15px lg:px-30px border dark:border-0 dark:border-b border-body-color dark:border-seondary-color relative z-10 group wow fadeInUp"
                  ...
                  <a href="service-details.html"
                    ...
                    <span
                      ...
                      <b className="text-xl md:text-size-25 lg:text-3xl">API Integrations</b>
                    </span>
                ...
                <div
                  ...
                  <a href="service-details.html"
                    ...
                    <span
                      ...
                      <b className="text-xl md:text-size-25 lg:text-3xl">Website Redesign</b>
                    </span>
                ...
                <div className="active-bg wow fadeInUp hidden sm:block" data-wow-delay=".6s"></div>
              </div>
            </div>
          </div>
        </section>
